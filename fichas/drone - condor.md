# Condor — drone mimético (Pack)

**SoT** de forma, sensores e envelope de voo.  
...
**SOP de coleta (não tutorial em prosa):** [context_pack_atual.md](../logs/context_pack_atual.md)
...
- **Payload canônico** = módulo tipo mochila (sinal / Agent / refrigeração). **Não** dois corpos.
...
## Envelope (projetado / anunciado)

| Campo | Valor | Nota de mesa |
| ----- | ----- | ------------ |
| Teto médio | **~3 km** | “quando estiver pronto” — ainda é o alvo; voos 02–03/08 já usam o pássaro |
| Rádio / conversa com o drone | **~8 km** | além disso = silêncio ou abort |
| Leitura fina (placa de carro) | **~7 km** | lentes refeitas para imitar visão de condor real |
| Alerta antecipado (aproximação) | **~80 km** típico | depende de dia e ar |
| Horizonte visual (teto + dia limpo) | **até ~190 km** | teto, não garantia de toda saída |
| Tempo de aviso no Pack | **15–40 min** na maioria dos casos | o que o céu compra |
| Autonomia em sobrevoo passivo | **até ~13 h** sem bater asa | só planando; bater asa gasta outra conta |
| Módulo de sinal | operacional (voos 30/07 e 02/08) | transporte **cego**; coleta = Agent na mochila |
