...
| -------------------- | ----- | -------------------- | ----- |
| Drive Land Vehicle   | 6     | Streetwise           | 4     |
| Handgun              | 5     | Tactics              | 4     |
| Vehicle Tech         | 5     | Stealth              | 4     |
| Perception           | 5     | Resist Torture/Drugs | 4     |
| Athletics            | 4     | First Aid            | 3     |
| Local Expert (Roads) | 3     | Endurance            | 3     |
| Brawling             | 3     | Melee Weapon         | 2     |
...
| ------------------------------------ | ---------------- | ------------- | ------------------------------------ |
| Transporte Armado (dentro da cidade) | 300 - 600 eb     | Baixo / Médio | Preço sobe em Combat Zones           |
| Transporte em Badlands               | 800 - 1.500 eb   | Médio / Alto  | Cobra mais por risco e combustível   |
| Extração Rápida                      | 1.500 - 3.000 eb | Alto          | Preço sobe se envolver confronto     |
| Escolta Armada                       | 1.000 - 2.500 eb | Médio / Alto  | Cobrado por hora ou por missão       |
| Smuggling (Contrabando)              | 2.000 - 5.000 eb | Alto          | Preço depende do tamanho da carga    |
| Proteção de Carga / Convoy           | 2.000 - 4.000 eb | Alto          | Serviço de maior risco e melhor pago |
| Resgate de Veículo                   | 1.200 - 2.500 eb | Médio / Alto  | Cobra extra se precisar usar força   |
| Aluguel como Base Móvel              | 400 - 800 eb/dia | Baixo         | Inclui ela como motorista/segurança  |

**Regras de Preço:** Metade adiantado + metade após a missão. +30~50% em zonas de alta periculosidade. +50~100% se envolver tiroteio. Descontos de 10~20% para clientes fixos e crews aliados.
...
| Uso | Arquivo | Notas |
| --- | ------- | ----- |
| Pack / job campo | `badlands_tactical.jpg` · `combat_cargo_olive.jpg` | **Dona habitual** pack/tático |
| Stealth / NC operacional | `stealth_black_jumpsuit.jpg` · `street_allblack_set.png` | |
