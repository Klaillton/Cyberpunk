...
Três aves mecânicas **miméticas**. Não são Vespas. Não são o Condor. Não são veículo.

| Campo | Canon |
| ----- | ----- |
| Quantidade | **3** unidades |
| Papel | recon **noturno** e voo **silencioso** (sessão 012) |
| Combate | **sem arma** |
...
- Não narrar como drone de combate / Vespa.
