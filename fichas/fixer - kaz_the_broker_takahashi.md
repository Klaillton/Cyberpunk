...
**Referência Visual:**  
<img src="../imagens/fixer%20-%20kaz_the_broker_takahashi.jpg" width="220" alt="Kaz &quot;The Broker&quot; Takahashi" />  
...
Veterano das sombras de Night City com rede extensa de contatos. Traído no passado por uma corp (ou rival Fixer), agora opera como broker independente, investindo em crews promissoras que podem realmente desafiar as megacorps. Vê grande potencial na crew do Ryan e está colocando euro e reputação nisso.

## Atributos (62 Pontos Distribuídos)
...
**Total gasto em Stats:** 62 pontos (balanceado para Fixer: alto COOL/INT para Operator/Haggle/Trading, EMP e Social Skills para contatos, REF/DEX para não morrer na primeira emboscada).

## Derivados Básicos

- HP Total: ~35 (BODY 5 + WILL 6 = 11 × 3 + modificadores)
- Seriously Wounded: ~17-18
- Death Save: BODY 5
- Humanidade (HL) inicial: Baseada em EMP 5 (50)

## Humanidade e Cyberware (sugerido inicial - foco em social/contatos, HL controlada)

- Neural Link + Interface Plugs (obrigatório para comms/Agent)
- Kiroshi Optics (visão aprimorada, análise facial)
- Cyberaudio Suite (com scrambler e voice stress analyzer para negociações)
- Biomonitor
- Subdermal Pocket (para esconder data chips ou credchips)
- Possivelmente Voice Stress Analyzer ou olfacto-boost para leitura de pessoas

## Skills Principais (foco Fixer - ~86 pontos padrão de skills)

- Operator (Role Ability): 6-7 (alto para Contacts, Reach, Haggle e Grease — essencial para broker de crews)
- Trading: 8 (mestre em negociar jobs, preços e favores)
- Streetwise: 7 (rede de contatos nas ruas)
- Persuasion: 7
- Human Perception: 7 (ler mentiras e intenções)
- Conversation: 6
- Bribery: 6
- Local Expert (Night City - áreas chave): 6
- Perception: 6
- Stealth: 5
- Bureaucracy: 5 (limpar rastros corporativos)
- Wardrobe & Style: 5 (aparência profissional)
- Deduction: 5
- Tactics: 5 (planejar operações)
- Outras básicas: Education 4, Library Search 4, Criminology 4, Resist Torture/Drugs 4, Handgun 4, Athletics 4, etc.

## Equipamento Inicial Sugerido

- Agent de alta qualidade, óculos espelhados com HUD, terno/jaqueta blindada leve (SP 11), pistola média ou leve para autodefesa, vários credchips, contatos em Night Markets, acesso a garagem segura para reuniões.
