...
- **Ryan:** Arquiteto/mentor de confiança; cautela residual pelo lado operador. E014 **não** está pendente — produção ok, farol público fechado de propósito.
- **Valk:** Parceira operacional de Ryan; liderou a apresentação das casas.
...
- **Não** anuncia infra nova ao pack geral sem medir olhar de fora (casas, Node, drones).
