...
- Nômade de meia-idade; rifle de precisão; posição elevada em scavs.
- Sem chrome corporativo pesado; visual de sentinel do acampamento, não Solo de NC.
...
- **Ryan:** Respeito operacional nas scavs; segue ordens de recon e perímetro.
- **Valk:** Integrante do time que ela monta (com Rusty + apoio).
