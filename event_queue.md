...
**Última atualização:** ~01 de Agosto de 2026 (pós-023) · Arco L1: [board/arco_ativo.md](board/arco_ativo.md)

## Eventos Ativos / Pendentes

| ID   | Evento                                           | Status       | Prioridade | Prazo Estimado   | Notas                                                      |
| ---- | ------------------------------------------------ | ------------ | ---------- | ---------------- | ---------------------------------------------------------- |
...
| **E015** | Viagem / assuntos Ryan em Night City (com Valk) | **Em andamento** | Alta | Curto prazo | **Fase:** 1º pacote 30/07. Intermediário **48–72h ainda aberto** (piso ~01/08 17h; teto ~02/08 17h). Sem burst em 023. Não forçar Sparrow/Steel. Débito **300 eb** pago. Lina Park sem ACK; Marcus Rivera mudo; Kaz off-screen. |
| E016 | Tutoria Valk + Sasha/Lira (assistentes) | Em andamento | Média | Contínuo | Residual positivo 019/022/023; Sasha confirmou mochila Condor 01/08 |
...
| E020 | Assistente para **Reyes** (cobra mimética) | Ideia | Baixa | Tempo livre | Conceito; Ryan ainda **não** apresentou |

## Eventos Resolvidos (Recentes)

| Evento                        | Data  | Resultado         | Impacto                                  |
| ----------------------------- | ----- | ----------------- | ---------------------------------------- |
| **E013 Caçada aves** | 16/07 | Sucesso | Material biológico para drones |
| **E010 Scav de containers** | 10/07 | Sucesso limpo | Container A rebocado; B desmontado |
| E009 Scav de **materiais** | 05/07 | Sucesso limpo | Material no depósito |
