...
> **Lente:** [background](../../fichas/notas_narrador/jax_razor_kane_background.md) · [ficha](../../fichas/solo%20-%20jax_razor_kane.md)

## Motivações Atuais

- Trabalho bom: pagamento em dia, alvo que faz sentido, operação difícil.
- Crew que **volta pelos seus** — não “perdas aceitáveis”. A reputação pós-BT entra aqui, não como cruzada anti-corp.
- Manter o ofício afiado: stand, academia, recce, manutenção de arma.
- Placar: bar, dardo, sinuca, carga. Nome no topo quando der; se não der, treina. Sem agressão.
- Chrome como ferramenta. Se funciona, fica.

## Perguntas de Pulso

**Sobre jobs:**

- Kaz ofereceu ou sondou trabalho que exija Jax?
- Ele treinou, fez manutenção de armas, ou recce em NC?
- Encontrou operação difícil o bastante — ou está só no aquecimento (bar / stand)?

**Sobre a crew:**

- Interagiu com Reina, **Stitch** ou Alex off-screen? (Stitch = Stephania; **não** confundir com Elisa “Doc” Moreau)
- Competiu com alguém (stand, academia, bar) sem transformar isso em briga?
- Comentou a dinâmica Ryan/Valkirya com humor negro de veterano — sem ciúme, sem mando?

**Sobre Ryan (remoto):**

- Ouviu histórias do pack (operador frio, 16 Raffen) via fixers?
- Vê Ryan como o cara que faz o equipamento funcionar sob fogo — ou como variável imprevisível?
- Está disposto a ir às Badlands se o job pagar e a extração fizer sentido?

**Geral:**

- Humor: seco, profissional, ou só entediado por falta de combate real?
- Algum contato antigo da Militech reapareceu? (recusa = estrutura, não vendetta)

## Eventos Off-Screen Recentes

- *(Aguardando primeiro ciclo com Ryan em NC ou job conjunto.)*
...
- **Ficha:** [fichas/solo - jax_razor_kane.md](../../fichas/solo%20-%20jax_razor_kane.md)
- **Background:** [jax_razor_kane_background.md](../../fichas/notas_narrador/jax_razor_kane_background.md)
