...
- **E015** — Viagem encerrada (retorno 27/07). Residual Sparrow/ad = off-screen NC, **não** catalisa Pack até rumor público.

---

## 1. Tabela de Eventos (rolagem diária)

| Categoria | Evento | Impacto | Limiar d100 | Máx./dia | Pulso | Observações |
| --------- | ------ | ------- | ----------- | -------- | ----- | ----------- |
| **Oficina / Veículos** | Alguém precisa de ajuda técnica urgente | 2 | 60 | 1 | [tio_gringo](tio_gringo.md) | Ryan ou Tio Gringo chamados |
| **Oficina / Veículos** | Experimento novo na oficina | 3 | 40 | 1 | [tio_gringo](tio_gringo.md) | + frequente se Ryan está ensinando |
| **Oficina / Veículos** | Tio Gringo trabalha sozinho por horas | 2 | 60 | 1 | [tio_gringo](tio_gringo.md) | Quase todo dia se passar |
| **Vida Diária** | Refeitório / rotina normal | 1 | 75 | 2* | [pulso_geral](pulso_geral.md) | *2ª só com catalisador; sem drama |
| **Vida Diária** | Pequeno conflito entre membros | 3 | 40 | 1 | [reyes](reyes.md) | Recursos, ciúmes, liderança |
| **Vida Diária** | Alguém sai do acampamento (caça, comércio, recon) | 2 | 60 | 1 | [reyes](reyes.md) | Rotina de pack |
| **Social** | Sasha/Lira tentam se aproximar de Valk | 2 | 60 | 1 (+1*) | [sasha_e_lira](sasha_e_lira.md) | *extra se catalisador social |
| **Social** | Fofoca / olhares sobre Ryan e Valk | **1** | **75** | **2** | [sasha_e_lira](sasha_e_lira.md), [valk](../crew/valk.md) | **Pode repetir no dia** com catalisador |
| **Social** | Ciúmes ou comentário negativo sobre o casal | 2 | 60 | 1 (+1*) | [valk](../crew/valk.md) | |
| **Social** | Namorado/marido quer “conversar” com Ryan | 4 | 18 | 1 | [reyes](reyes.md) | Cooldown 7 dias |
| **Social** | Comentário sobre o “lado frio” de Ryan | 2 | 60 | 1 (+1*) | [sasha_e_lira](sasha_e_lira.md) | Admiração + receio |
| **Social** | Crianças interagem com Ryan (ou falam dele) | 2 | 60 | 1 | [criancas](criancas.md) | |
| **Recrutas** | Desempenho / tensão entre Mara, Elias, Tomas | 3 | 40 | 1 | [recrutas](recrutas.md) | Supervisão ativa pós-02/07 |
| **Ameaças** | Rumor ou avistamento Raffen | 5 | 8 | 1 | [reyes](reyes.md) | Cooldown 14 dias |
...
- **22–27/07/2026 — GAP B1 (sem pulso formal):** sessões 016–019 sem ciclos d100. **Não** inventar rolagem retroativa. Estado derivado dos resumos: Pack em rotina estável; Ryan+Valk+Sasha+Lira ausentes 24–27 (viagem industrial); retorno limpo 27/07 noite; **sem evento local relevante**. Retomar d100 no próximo amanhecer (~28/07).

---

## 3. Ganchos para Ryan

Eventos que podem puxar Ryan de volta para a cena:
...
- Membro do pack (ou parceiro de alguém) quer “conversar” sobre como Ryan se porta com as mulheres.
...
- **Relacionamentos de Ryan:** [relacionamentos/ryan_relacionamentos.md](../../relacionamentos/ryan_relacionamentos.md)
- **Relacionamentos de Valk:** [relacionamentos/lena_valk_kane_relacionamentos.md](../../relacionamentos/lena_valk_kane_relacionamentos.md)
- **Consequências Persistentes:** [consequencias/consequencias_persistentes.md](../../consequencias/consequencias_persistentes.md)
