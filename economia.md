...
| Agent stack WIREGHOST | Honeypot (visível) · Profissional (subdermal) · Vault (implant, offline) | [F19](sistema/fatos_duros.md) · [agent_security](plans/agent_security.md) · [loadout](fichas/ryan_loadout.md) |
