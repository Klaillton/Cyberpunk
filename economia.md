...
| ----------------- | -------------------------------- | ------------------------------- |
| Autonomia técnica | Em crescimento                   | Ensino de fabricação e precisão |
| Defesa            | Fortemente melhorada             | Perímetro + Mule atualizado     |
...
| Materiais         | Depósito suficiente para protótipo | Inventário confirmado na sessão 007 |
...
- O Pack está ganhando autonomia técnica graças ao ensino de Ryan.
- **Badlands Node v0.1** pode gerar excedente via destilaria (Elias) e reduzir dependência externa de água/comida.
...
- Excedente da destilaria e produção do Node podem abrir comércio local.
...
- [Ficha Ryan](fichas/techie%20-%20ryan_wireghost_voss.md) · [Downtime](logs/downtime_ryan.md) · [Sessão 007](logs/sessao_resumo_007.md)
