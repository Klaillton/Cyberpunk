...
| Período | Almoço (Pack) — Condor **no ar** |
| Região | **Badlands / Pack** |
| Local específico | Oficina (Ryan + Tio); Valk + Sasha + Lira no gancho do Condor |
| Facção / base local | Pack Nômade Badlands |
| Cena / gancho | Almoço no ar; Condor voando, sem pacote ainda; teto do intermediário **à tarde** |
| Prioridade | (1) Almoço / downtime (2) Condor pousar / pacote (3) Teto intermediário à tarde |
...
**Pack — almoço ~02/08.**  
Ryan na oficina (Tio no ferro; Vespas/Warden/armas acabaram de ser vistos). Valk ficou com Sasha/Lira no gancho: *“Eu fico. Ele está na oficina. Qualquer burst, a gente chama.”* Condor é um ponto no corredor, **sem pacote**. Almoço no ar. Teto do intermediário ainda à tarde.
...
| - | ---------------- | ---------------- | ---------------------------------------------- |
| 1 | Almoço / downtime (Ryan oficina → refeitório) | Valk / Tio | Valk chama ou Tio larga o ferro; **prosa ok** |
| 2 | Condor no ar — pacote ainda não | Sasha/Lira / mundo | Pouso, burst, ou silêncio até o pássaro voltar |
| 3 | Teto do intermediário **à tarde** | Mundo / fixer | Burst **ou** silêncio com custo depois do teto |

| Campo | Valor |
| ----- | ----- |
| **Modo atual** | DOWNTIME / Pack (almoço; Condor no ar) |
...
**Trava 023 (não reabrir):** Condor ~02/08 não se renegocia; base = mensagem → manhã seguinte; overwatch dela só nesse dia; 019 em vigor. **Não** reabrir o jantar como briga.

### Voz Valkirya (boot — não pular)

Residual íntimo **alto**. Paz física feita de manhã 01/08. Chat **023 contaminado** (Night City XIII) — **não** herdar o registro de CO.

- Ops/público: curta e seca. Com Ryan agora: curta **e** quente (toque + 1 frase que não é ordem).
- Acordo 019 = **perguntar uma vez** antes de vetar. Plano já fechado = não reabre.
- **Proibido:** “três coisas”, “fecha antes de dormir”, “sem isso eu não top”, “eu decido”, “tribunal”, silêncio de castigo.
- Exemplos: [arco_ativo §7](../board/arco_ativo.md). Detalhe: [diretrizes §3.3](../sistema/diretrizes_narrador.md).
...
| ID | Uma linha |
| -- | --------- |
| **E015** | 1º pacote 30/07; intermediário **teto à tarde 02/08**; Lina Park sem ACK; Marcus Rivera mudo; Kaz escondido |
