...
| **F23** | **Leopold von und zu Habsbrück** = Rockerboy da crew (NC, off-screen). Handle público = **Prometheus**. Chama de três linhas ≠ brasão Habsbrück. ≠ Echo. ≠ Voodoo Boys (Zoners, célula local, parked). Avó / teia / job do Kaz / líder Zoner = **só** [nota do narrador](../fichas/notas_narrador/leopold_habsbruck_background.md). CI **6**. Não narrar no Pack | ficha rockerboy · nota |
...
- Não narrar **Leopold / Prometheus** no Pack. Não despejar teia Habsbrück / avó / job do Kaz / semanas Zoners / grafite na cerca. Handle = **Prometheus**. Chama ≠ brasão. ≠ Echo. ≠ Voodoo Boys (**F23**).
