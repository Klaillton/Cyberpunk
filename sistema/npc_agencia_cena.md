...
**Valk:** "Equipamento: rifle leve ou arco — o que você preferir levar, eu cubro munição e kit de campo. **Scout** fica de overwatch no alto do cânion se ele topar; senão, **Rusty** no rádio do acampamento. **Reyes** não precisa saber ainda — é caça, não incursão."
...
- **Veto ou ajuste** explícito: "sem Scout", "saímos mais cedo", "quero arco, não rifle".
