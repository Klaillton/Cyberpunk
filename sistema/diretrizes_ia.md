...
- Regras de beat: [diretrizes_narrador.md](diretrizes_narrador.md) **§7.1** (N1–N13) · **§5.2** (N13 situar) · [motor_cena_1pager.md](motor_cena_1pager.md). Agência: [npc_agencia_cena.md](npc_agencia_cena.md).
