...
**Última atualização:** 2026-08-30 (background Jax: Solo puro / placar; próximo resumo **024**)
...
│   ├── vehicle - the_mule.md
│   ├── reina_armour_project.md    ← Ideia futura (não canônico)
│   ├── reina_byke_project.md      ← Ideia futura (não canônico)
│   ├── npc/                       ← Fichas mínimas (um NPC por arquivo)
│   │   ├── npc_template.md
│   │   ├── dr_elias_vossler.md
│   │   ├── lina_park.md           ← Sparrow (F20)
│   │   ├── marcus_steel_rivera.md ← Steel (F20) · ≠ Echo Rivera
│   │   ├── reyes.md
│   │   ├── tio_gringo.md
│   │   ├── mara_recruit.md
│   │   ├── elias_recruit.md
...
│       ├── ryan_valor_pack.md
│       ├── lena_valkyria_kane_background.md
...
│       ├── jax_razor_kane_background.md      ← Jax; Solo puro / placar
...
│   ├── sessao_resumo_001.md … sessao_resumo_019.md
...
├── ideas_concepts/                ← Soft-canon (NÃO tier-0; ver README)
│   ├── README.md
│   ├── 00_RYAN_CANON_CONSOLIDADO.md
│   ├── 01_habilidades_latentes.md … 06_canon_arco_resumo.md
├── plans/                         ← Planos de trabalho (não estado de campanha)
│   ├── README.md
│   ├── add-cyberpunk-red-mechanics.md
│   ├── agent_security.md
│   ├── auditoria_combates_canonicos.md
│   └── phase_2.md
└── sistema/
    ...
    ├── echo_exposicao.md          ← Void List / Null / vazamento Echo
...
| `sistema/instrucoes_projeto.md` | Ativo | Instruções do projeto (espelho versionado) | `diretrizes_ia.md`, este arquivo |
...
- [Dashboard de Contexto](dashboard_contexto.md) · [Board](../board/board_campanha.md) · [Arco](../board/arco_ativo.md)
