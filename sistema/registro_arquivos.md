...
**Padrão de resumos de sessão:** `logs/sessao_resumo_XXX.md` (ex.: `001` … `021`). Próximo número disponível: **024**.

---

## Estrutura Geral do Projeto

Ver árvore completa no histórico do arquivo até o restore. A nota de narrador do Jax vive em `fichas/notas_narrador/jax_razor_kane_background.md`.
