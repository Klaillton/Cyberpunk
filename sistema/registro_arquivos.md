...
**Última atualização:** 2026-08-12 (Finalizar sessão 018; Ruleset v1.3.0; próximo resumo **019**)
...
**Padrão de resumos de sessão:** `logs/sessao_resumo_XXX.md` (ex.: `001` … `018`). Próximo número disponível: **019**.
...
- **Resumos de Sessão:** Padrão `logs/sessao_resumo_XXX.md`. Próximo número: **019**.
