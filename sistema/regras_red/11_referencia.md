...
**Ruleset atual:** ver [versionamento_regras.md](../versionamento_regras.md) (**1.3.0**).  
...
Apresentar: d10 · STAT · Skill · mods · total · DV/oposto · resultado · consequência.
...
Iniciativa `REF+1d10` · Ataque skill arma · vs DV ou Evasion · Dano − SP → HP · SW em ½ HP · Death Save se HP ≤ 0.
...
```text
INTENÇÃO → RISCO → REGRA → FICHA → MODS → ROLAGEM → RESULTADO → ESTADO → NARRAÇÃO
```
