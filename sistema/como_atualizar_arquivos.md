...
| Vazamento / propaganda da Echo | `sistema/echo_exposicao.md` + `heat.md` + `reputacao.md` (nível 0–4; Void List vs rostos) |
...
- [Dashboard](dashboard_contexto.md) · [Diretrizes IA](diretrizes_ia.md) · [Novo Chat](novo_chat_procedimento.md) · [Pulso](pulso_procedimento.md)
