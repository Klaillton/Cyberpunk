...
| --------------------------- | --------- | -------------- | -------------------------------------------------------------------------------- |
| **Pack Nômade de Badlands** | +65       | Muito Positiva | Ryan é visto como protetor e professor. Valk é aceita como uma das suas.         |
...
| **Kaz "The Broker"**        | +40       | Positiva       | Vê potencial na crew e está trazendo mais jobs.                                  |
| **Crew (interna)**          | +25       | Positiva       | Respeito geral, mas existe tensão após Ryan confrontar o time.                   |

## Reputação por NPC Importante

| NPC                      | Reputação | Tipo de Relação      | Notas                           |
| ------------------------ | --------- | -------------------- | ------------------------------- |
| Lena "Valk" Kane         | +85       | Romântica / Aliada   | Relação consolidada e profunda  |
