...
| Personagem | Interesse Principal       | Motivação Principal                    | Conflito Interno                               | Comportamento Esperado                           |
| ---------- | ------------------------- | -------------------------------------- | ---------------------------------------------- | ------------------------------------------------ |
| **Ryan**   | Valk (base)               | Evitar dor emocional                   | Medo de ser trocado / abandonado               | Tende a se fechar emocionalmente (operador frio) |
| **Valk**   | Ryan + atração por Alex   | Manter Ryan + explorar desejo por Alex | Possessiva, mas Alex a desmonta com facilidade | Dividida, sente culpa                            |
| **Alex**   | Valk (principal)          | Conquistar Valk                        | Interesse secundário em Ryan (inicialmente)    | Provocadora e calculista (não muito agressiva)   |
| **Reina**  | Ryan (em desenvolvimento) | Proteger Ryan                          | Começa a sentir algo por ele contra a vontade  | Protetora, tenta negar os sentimentos no começo  |
